...
export function AnalyticsView() {
  ...
  const [activeSubTab, setActiveSubTab] = React.useState("daily")
  ...
  return (
    <div className="@container/main flex flex-1 flex-col gap-4 p-4">
      <motion.div variants={stagger} initial="hidden" animate="show" className="space-y-5">
        {/* Month Selector */}
        {availableMonths.length > 0 && (
          <motion.div variants={fadeUpSmall} className="flex justify-end">
            <MonthSelector
        ...
        {/* ── Spending Comparison (standalone widget, hidden when Comparison tab is active to avoid duplication) ── */}
