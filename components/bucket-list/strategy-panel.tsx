 ...
 *
 * Displays an AI-generated savings strategy as rich Markdown content.
 * The strategy is generated by the backend using the user's financial context
 * and the specific bucket list item details.
 *
 * Features:
 * - Renders strategy content as formatted Markdown via InsightMarkdown
 ...
 *
 * @property strategy - The AI-generated strategy text in Markdown format
 ...
 *
 * Shows either the generated strategy as Markdown, a loading skeleton
 * while generating, or nothing if no strategy data is available.
