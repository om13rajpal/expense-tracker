/**
 * Type definitions for AI-generated financial insights.
 *
 * Defines the structured data shapes returned by the AI analysis pipeline
 * for each insight type: spending analysis, monthly/weekly budgets, investment
 * insights, tax optimization tips, and planner recommendations. Also defines
 * the pipeline context, options, and persistence document shape.
 *
 * @module lib/ai-types
 */

/**
 * Discriminated union of AI insight types generated by the pipeline.
 * Each type corresponds to a specific LLM prompt and structured output format.
 */
